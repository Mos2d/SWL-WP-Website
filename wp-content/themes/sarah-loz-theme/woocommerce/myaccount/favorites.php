<?php
/**
 * My Account Favorites template
 *
 * Shows the favorite products in the My Account section
 */

defined('ABSPATH') || exit;

// Get favorites passed from the favorites_content function
$user_id = isset($args['user_id']) ? $args['user_id'] : get_current_user_id();
$all_favorites = isset($args['all_favorites']) ? $args['all_favorites'] : [];
$products = isset($args['products']) ? $args['products'] : [];
$activities = isset($args['activities']) ? $args['activities'] : [];
...
<div class="woocommerce-favorites">
    ...
    if (current_user_can('administrator')) : ?>
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-4">
            ...
            <p>جميع المفضلة: <?php echo !empty($all_favorites) ? implode(', ', $all_favorites) : 'فارغ'; ?></p>
